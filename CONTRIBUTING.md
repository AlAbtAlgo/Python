...
Welcome to [TheAlgorithms/Python](https://github.com/AlAbtAlgo/Python)! Before sending your pull requests, make sure that you **read the whole guidelines**. If you have any doubt on the contributing guide, please feel free to [state it clearly in an issue](https://github.com/AlAbtAlgo/Python/issues/new) or ask the community in [Gitter](https://gitter.im/AlAbtAlgo).
...
Your contribution will be tested by our [automated testing on Travis CI](https://travis-ci.org/AlAbtAlgo/Python/pull_requests) to save time and mental energy.  After you have submitted your pull request, you should see the Travis tests start to run at the bottom of your submission page.  If those tests fail, then click on the ___details___ button try to read through the Travis output to understand the failure.  If you do not understand, please leave a comment on your submission page and a community member will try to help.
...
- If you are submitting code in the `project_euler/` directory, please also read [the dedicated Guideline](https://github.com/AlAbtAlgo/Python/blob/master/project_euler/README.md) before contributing to our Project Euler library.
- The file extension for code files should be `.py`. Jupyter Notebooks should be submitted to [AlAbtAlgo/Jupyter](https://github.com/AlAbtAlgo/Jupyter).
...
- Add a corresponding explanation to [Algorithms-Explanation](https://github.com/AlAbtAlgo/Algorithms-Explanation) (Optional but recommended).
